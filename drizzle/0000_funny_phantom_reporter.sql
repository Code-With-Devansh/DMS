...
CREATE INDEX "org_idx" ON "users" USING btree ("org");--> statement-breakpoint
...
CREATE INDEX "cases_jurisdiction_idx" ON "cases" USING btree ("jurisdiction");--> statement-breakpoint
